...
clear all
close all
Name=['D:\Dropbox\PhD Expriments\Matlab\DEAP_MatlabCodes\Deap_EEG&Peripheral_featuretable.mat'];
load(Name);

Tr=4; %classification based on Valence=1,Arousal=2,Liking=4......Must be set before running/ 5 is for classification based on emotional state
...
nInput=294;  %numbers of totoal features 
...
for i = 1:nInput
D(:,i) = mat2gray(mixedfeatures_table(:,i))
end
